 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://server.demo/", wsdlLocation = "http://localhost:8091/user?wsdl")
    ...
    extends Service
{
    ...
    private static final QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://server.demo/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8091/user?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://server.demo/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.demo/", "UserServiceImplPort"), UserService.class, features);
    }
